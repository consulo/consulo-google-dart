...
public class DartElementGenerator {
  ...
  public static DartLibraryComponentReferenceExpression createLibraryComponentReference(Project myProject, String name) {
    ...
    final DartLibraryReferenceList libraryReferences =
      combinators != null && !combinators.isEmpty() ? combinators.iterator().next().getLibraryReferenceList() : null;
    final List<DartLibraryComponentReferenceExpression> references =
      libraryReferences != null ? libraryReferences.getLibraryComponentReferenceExpressionList() : null;
  ...
  public static PsiFile createDummyFile(Project myProject, String text) {
    ...
    final PsiFile psiFile = factory.createFileFromText(name, DartLanguage.INSTANCE, text);
    assert psiFile != null;
    return psiFile;
  }
}

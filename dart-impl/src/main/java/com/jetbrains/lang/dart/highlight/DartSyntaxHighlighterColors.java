...
public class DartSyntaxHighlighterColors
{
	...
	public static final TextAttributesKey LINE_COMMENT = createTextAttributesKey(DART_LINE_COMMENT, DefaultLanguageHighlighterColors.LINE_COMMENT);
	public static final TextAttributesKey BLOCK_COMMENT = createTextAttributesKey(DART_BLOCK_COMMENT,
			DefaultLanguageHighlighterColors.BLOCK_COMMENT);
	public static final TextAttributesKey DOC_COMMENT = createTextAttributesKey(DART_DOC_COMMENT, DefaultLanguageHighlighterColors.DOC_COMMENT);
	...
	public static final TextAttributesKey VALID_STRING_ESCAPE = createTextAttributesKey(DART_VALID_STRING_ESCAPE,
			DefaultLanguageHighlighterColors.VALID_STRING_ESCAPE);
	public static final TextAttributesKey INVALID_STRING_ESCAPE = createTextAttributesKey(DART_INVALID_STRING_ESCAPE,
			DefaultLanguageHighlighterColors.INVALID_STRING_ESCAPE);
	public static final TextAttributesKey OPERATION_SIGN = createTextAttributesKey(DART_OPERATION_SIGN,
	...
	public static final TextAttributesKey STATIC_MEMBER_FUNCTION = createTextAttributesKey(DART_STATIC_MEMBER_FUNCTION,
			DefaultLanguageHighlighterColors.STATIC_METHOD);
	public static final TextAttributesKey STATIC_MEMBER_FUNCTION_CALL = createTextAttributesKey(DART_STATIC_MEMBER_FUNCTION_CALL,
			DefaultLanguageHighlighterColors.STATIC_METHOD);
	public static final TextAttributesKey INSTANCE_MEMBER_FUNCTION = createTextAttributesKey(DART_INSTANCE_MEMBER_FUNCTION,
			DefaultLanguageHighlighterColors.INSTANCE_METHOD);
	public static final TextAttributesKey INSTANCE_MEMBER_FUNCTION_CALL = createTextAttributesKey(DART_INSTANCE_MEMBER_FUNCTION_CALL,
			DefaultLanguageHighlighterColors.FUNCTION_CALL);
	public static final TextAttributesKey INHERITED_MEMBER_FUNCTION_CALL = createTextAttributesKey(DART_INHERITED_MEMBER_FUNCTION_CALL,
			DefaultLanguageHighlighterColors.FUNCTION_CALL);
	public static final TextAttributesKey ABSTRACT_MEMBER_FUNCTION_CALL = createTextAttributesKey(DART_ABSTRACT_MEMBER_FUNCTION_CALL,
			DefaultLanguageHighlighterColors.FUNCTION_CALL);
	public static final TextAttributesKey INSTANCE_MEMBER_VARIABLE = createTextAttributesKey(DART_INSTANCE_MEMBER_VARIABLE,
			DefaultLanguageHighlighterColors.INSTANCE_FIELD);
	public static final TextAttributesKey INSTANCE_MEMBER_VARIABLE_ACCESS = createTextAttributesKey(DART_INSTANCE_MEMBER_VARIABLE_ACCESS,
			DefaultLanguageHighlighterColors.INSTANCE_FIELD);
	public static final TextAttributesKey STATIC_MEMBER_VARIABLE = createTextAttributesKey(DART_STATIC_MEMBER_VARIABLE,
			DefaultLanguageHighlighterColors.STATIC_FIELD);
	public static final TextAttributesKey STATIC_MEMBER_VARIABLE_ACCESS = createTextAttributesKey(DART_STATIC_MEMBER_VARIABLE_ACCESS,
			DefaultLanguageHighlighterColors.STATIC_FIELD);
	public static final TextAttributesKey LOCAL_VARIABLE = createTextAttributesKey(DART_LOCAL_VARIABLE,
			DefaultLanguageHighlighterColors.LOCAL_VARIABLE);
	public static final TextAttributesKey LOCAL_VARIABLE_ACCESS = createTextAttributesKey(DART_LOCAL_VARIABLE_ACCESS,
			DefaultLanguageHighlighterColors.LOCAL_VARIABLE);
	public static final TextAttributesKey FUNCTION = createTextAttributesKey(DART_FUNCTION, DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);
	...
	public static final TextAttributesKey CONSTRUCTOR_CALL = createTextAttributesKey(DART_CONSTRUCTOR_CALL,
			DefaultLanguageHighlighterColors.FUNCTION_CALL);
	public static final TextAttributesKey CONSTRUCTOR_DECLARATION = createTextAttributesKey(DART_CONSTRUCTOR_DECLARATION,
			DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);
	public static final TextAttributesKey TOP_LEVEL_FUNCTION_DECLARATION = createTextAttributesKey(DART_TOP_LEVEL_FUNCTION_DECLARATION,
			DefaultLanguageHighlighterColors.FUNCTION_DECLARATION);
	public static final TextAttributesKey TOP_LEVEL_FUNCTION_CALL = createTextAttributesKey(DART_TOP_LEVEL_FUNCTION_CALL,
			DefaultLanguageHighlighterColors.FUNCTION_CALL);
	public static final TextAttributesKey TOP_LEVEL_VARIABLE_DECLARATION = createTextAttributesKey(DART_TOP_LEVEL_VARIABLE_DECLARATION,
			DefaultLanguageHighlighterColors.GLOBAL_VARIABLE);
	public static final TextAttributesKey TOP_LEVEL_VARIABLE_ACCESS = createTextAttributesKey(DART_TOP_LEVEL_VARIABLE_ACCESS, DefaultLanguageHighlighterColors.GLOBAL_VARIABLE);
}

	...
	EXTRA_ARGUMENT
			...
			}, UNDEFINED_GETTER
		{
			...
			public List<? extends IntentionAction> getFixes(@Nonnull PsiFile file, int startOffset, @Nonnull String message)
			{
				...
				return elementAt == null ? Collections.<IntentionAction>emptyList() : Arrays.asList(new CreateDartGetterSetterAction(elementAt.getText(), true, isStaticContext(file, startOffset)));
			}
		}, UNDEFINED_SETTER
		{
			@Nonnull
			...
			public List<? extends IntentionAction> getFixes(@Nonnull PsiFile file, int startOffset, @Nonnull String message)
			{
				...
				PsiElement elementAt = file.findElementAt(startOffset);
				return elementAt == null ? Collections.<IntentionAction>emptyList() : Arrays.asList(new CreateDartGetterSetterAction(elementAt.getText(), false, isStaticContext(file, startOffset)));
			}
		}, UNDEFINED_METHOD
		{
			@Nonnull

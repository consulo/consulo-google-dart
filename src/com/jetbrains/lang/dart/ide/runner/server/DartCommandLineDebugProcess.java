...
public class DartCommandLineDebugProcess extends XDebugProcess
{
	...
	private static final Set<String> CORE_LIBS = new THashSet<String>(Arrays.asList("dart:core", "dart:coreimpl", "dart:nativewrappers"));
	...
	private final List<Pair<JsonObject, AbstractResponseToRequestHandler<JsonResponse>>> postponedCommands = new LinkedList<Pair<JsonObject, AbstractResponseToRequestHandler<JsonResponse>>>();

	private final LinkedList<Pair<JsonObject, AbstractResponseToRequestHandler<JsonResponse>>> commandsToWrite = new LinkedList<Pair<JsonObject, AbstractResponseToRequestHandler<JsonResponse>>>()
	{
		@Override
	...
	public DartCommandLineDebugProcess(@NotNull XDebugSession session, int debuggingPort, ExecutionResult executionResult) throws IOException
	{
		super(session);

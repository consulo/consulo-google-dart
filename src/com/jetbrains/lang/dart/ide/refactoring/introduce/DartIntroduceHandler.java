...
public abstract class DartIntroduceHandler implements RefactoringActionHandler
{
	...
	{
		CommonRefactoringUtil.showErrorHint(project, editor, DartBundle.message("refactoring.introduce.selection.error"), myDialogTitle,
	...
	protected PsiElement performRefactoring(@NotNull DartIntroduceOperation operation)
	{
		...
		if(anchor == null)
		{
			CommonRefactoringUtil.showErrorHint(operation.getProject(), operation.getEditor(), RefactoringBundle.getCannotRefactorMessage(DartBundle
					.message("dart.refactoring.introduce.anchor.error")), DartBundle.message("dart.refactoring.introduce.error"), null);
			return null;
		}

...
public class DartMethodOverrideMarkerProvider implements LineMarkerProvider
{
	...
	private static LineMarkerInfo tryCreateOverrideMarker(final DartComponent methodDeclaration, List<DartComponent> superItems)
	{
		...
		}, new GutterIconNavigationHandler<PsiElement>()
		{
			...
			{
				PsiElementListNavigator.openTargets(e, DartResolveUtil.getComponentNames(filteredSuperItems).toArray(new
						NavigatablePsiElement[filteredSuperItems.size()]), DaemonBundle.message("navigation.title.super.method",
						methodDeclaration.getName()), DaemonBundle.message("navigation.findUsages.title.super.method", methodDeclaration.getName()),
